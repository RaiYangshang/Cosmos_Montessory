...
<body bgcolor="E9967A">
        <ul id="menu">
			...
			<center>
			 ...
			 <p>
			 We believe that each child is an individual, which is why no two paths through 
			 Friendship Montessori are the same. Instead of a set curriculum, students are given
			 time and space to follow their talents and interests, learning independently as well
			 as one-on-one with teachers. In everything we do, we focus on educating the whole 
